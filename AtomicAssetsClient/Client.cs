namespace AtomicAssetsClient
{
    ...
    public class Client : IClient
    {
        ...
        public Task<Template> GetTemplate(string collection, int templateId)
        {
            ...
            var uri = $"/atomicassets/v1/templates/{collection}/{templateId}";
            return ExecuteGetRequest<Template>(uri);
        }

        public Task<List<Template>> GetTemplates(string? collection = null, int maxPages = 0)
        {
            var uri = string.IsNullOrEmpty(collection)
